                ...
                <div className="container-fluid col-wrap">
                    <div className="row-fluid">
                        <div className="span8">
                            ...
                            <div>
                                <p>GPO-health Apps supports the following browsers</p>
                               ...
                               <p>Only supported browsers can be used to access gpo-health apps  – all others may result in an error message and an inability to proceed.</p>
                               
                                <div><a href="https://support.microsoft.com/en-us/help/17621/internet-explorer-downloads" target="_blank">
                                ...
                                <div><br /></div>
                                <div style={{ textAlign: 'left' }}><a href="https://www.google.com/chrome/browser/desktop/index.html" target="_blank" >
                                ...
                                <div><em>(click icon to download for free)</em></div>
                                <div><br /></div>
                                <div><a href="https://www.mozilla.org/en-US/firefox/new/?f=118" target="_blank" >
                                ...
                                <div><br /></div>
                                <div><a href="https://support.apple.com/downloads/safari" target="_blank" >
